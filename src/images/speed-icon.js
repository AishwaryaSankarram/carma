    ...
    '<g id="Page-1" stroke="none" stroke-width="1" fill="colour" fill-rule="evenodd">', 
       ' <g id="Group">',
           ...
           ' <text id="SPEED" font-family="Arial-BoldMT, Arial" font-size="20" font-weight="bold" letter-spacing="0.695652187" fill="#FFFFFF">',
                '<tspan x="12" y="32">SPEED</tspan>',
            '</text>',
            '<text id="40" font-family="Arial-BoldMT, Arial" font-size="40" font-weight="bold" letter-spacing="2.43478274" fill="#FFFFFF">',
                '<tspan x="20" y="80">SpeedVal</tspan>',
           '</text>',
           '<text xmlns="http://www.w3.org/2000/svg" id="MPH" font-family="Arial-BoldMT, Arial" font-size="20" font-weight="bold" fill="#FFFFFF">',
                '<tspan x="20" y="110">MPH</tspan>',
           '</text>',
        '</g>',
    '</g>',
'</svg>'
